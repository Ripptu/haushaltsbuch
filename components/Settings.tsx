...
const Settings: React.FC<Props> = ({ onReset }) => {
  return (
    <div className="max-w-2xl mx-auto p-4 md:p-6 space-y-8 min-h-screen">
       <motion.div 
        ...
        >
         ...
         <h2 className="text-2xl font-light text-white">Einstellungen</h2>
       </motion.div>
       ...
       <motion.div 
        ...
        >
         ...
         <section className="space-y-4">
           <h3 className="text-xs text-zinc-500 font-medium uppercase tracking-widest pl-2">Profil</h3>
         ...
         {/* Preferences Section */}
         <section className="space-y-4">
           <h3 className="text-xs text-zinc-500 font-medium uppercase tracking-widest pl-2">Präferenzen</h3>
           <div className="bg-vamela-surface border border-white/5 rounded-2xl overflow-hidden divide-y divide-white/5">
             <div className="p-4 flex items-center justify-between hover:bg-white/5 transition-colors cursor-pointer">
                <div className="flex items-center gap-3">
                   ...
                   <span className="text-zinc-200 text-sm">Erscheinungsbild</span>
                </div>
             ...
             <div className="p-4 flex items-center justify-between hover:bg-white/5 transition-colors cursor-pointer">
                <div className="flex items-center gap-3">
                   ...
                   <span className="text-zinc-200 text-sm">Benachrichtigungen</span>
                </div>
             ...
             <div className="p-4 flex items-center justify-between hover:bg-white/5 transition-colors cursor-pointer">
                <div className="flex items-center gap-3">
                   ...
                   <span className="text-zinc-200 text-sm">Sicherheit</span>
                </div>
                <span className="text-xs text-zinc-500">2FA Aktiv</span>
             </div>
           </div>
         </section>
          ...
          {/* Data Section */}
         <section className="space-y-4">
           <h3 className="text-xs text-zinc-500 font-medium uppercase tracking-widest pl-2">Datenverwaltung</h3>
           <div className="bg-vamela-surface border border-white/5 rounded-2xl overflow-hidden divide-y divide-white/5">
             <div className="p-4 flex items-center justify-between hover:bg-white/5 transition-colors cursor-pointer">
                <div className="flex items-center gap-3">
                   <Database size={18} className="text-zinc-400" />
                   <span className="text-zinc-200 text-sm">Exportieren (CSV)</span>
                </div>
             </div>
           </div>
         </section>
